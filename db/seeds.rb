...
# end
    ...
    l4 = Listing.create(location: "Compton", image_url: "https://images.craigslist.org/00E0E_hgPKmrMDk5nz_0t20CI_600x450.jpg", what_it_is: "Livestrong Treadmill", category: "Exercise Equipment", description: "Currently isnt working, showing an error on the panel. Believe it needs a new motherboard.", user_id: u1.id, winner_id: nil, end_time: "06-01-2022T20:45:50")
    l5 = Listing.create(location: "Compton", image_url: "https://images.craigslist.org/00G0G_5bfk2Z45lx2z_05a03Q_600x450.jpg", what_it_is: "Free Dirt", category: "Landscaping", description: "Free dirt with about half cay…..the photo is old, but its the same dirt from last fall.clean soil no crap in it . 50%dirt and 50% clay. You can park in the alley at 152 North Euclid Ave Oak Park….just walk thru the green gate ….you will see it on your left in front of the garage……. 5or 7…..10 gal. buckets worth… Tim", user_id: u1.id, winner_id: nil, end_time: "06-01-2022T20:45:50")
    l6 = Listing.create(location: "Compton", image_url: "https://images.craigslist.org/00R0R_mNVnc0F9Jrz_0t90CI_600x450.jpg", what_it_is: "wheeled carry on travel bag", category: "Bags", description: "wheeled carry on travel bag", user_id: u1.id, winner_id: nil, end_time: "06-01-2022T20:45:50")
    l7 = Listing.create(location: "Compton", image_url: "https://assets.specialized.com/i/specialized/96120-41_ROLL-ELITE-LTD-BLK-CMLNGRN-HLGCP_FDSQ?bg=rgb(241,241,241)&w=2500&h=1406&fmt=auto", what_it_is: "Kush Cycle", category: "Bikes", description: "Flex on all your friends", user_id: u1.id, winner_id: nil, end_time: "06-01-2022T20:45:50")

    l8 = Listing.create(location: "ABC", image_url: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQzGy30oLdBfwHCYUuKS3eH0xFqJie_q0lANg&usqp=CAU", what_it_is: "Swag", category: "Cool Factor", description: "Step up your game", user_id: u3.id, winner_id: nil, end_time: "06-01-2022T20:45:50")
    l9 = Listing.create(location: "DEF", image_url: "https://i.pinimg.com/236x/e3/70/08/e37008af8900b12e02f89847abd0de8a--random-pictures-the-day.jpg", what_it_is: "Bush Monster", category: "Outdoor", description: "Get your hedge trimmers!", user_id: u3.id, winner_id: nil, end_time: "06-01-2022T20:45:50")
    l10 = Listing.create(location: "GHI", image_url: "https://www.awesomeinventions.com/wp-content/uploads/2018/02/feb1518_1.jpg", what_it_is: "Brand new remote", category: "Electronics", description: "TV remote with AA batteries, brand new", user_id: u3.id, winner_id: nil, end_time: "06-01-2022T20:45:50")
    ...
    l12 = Listing.create(location: "MNO", image_url: "https://image.invaluable.com/housePhotos/linkauctiongalleries/24/698324/H18786-L249787047.JPG", what_it_is: "Assorted item", category: "Misc", description: "Re-clutter your home!", user_id: u6.id, winner_id: nil, end_time: "06-01-2022T20:45:50")
    l13 = Listing.create(location: "PQR", image_url: "https://static01.nyt.com/images/2020/11/26/fashion/18PIG-COUCH/18PIG-COUCH-mobileMasterAt3x-v3.jpg", what_it_is: "Wilbert", category: "Home", description: "Relax in style", user_id: u5.id, winner_id: nil, end_time: "06-01-2022T20:45:50")
