...
# end
    ...
    l1 = Listing.create(location: "Compton", image_url: "https://images.craigslist.org/00C0C_gHxNjOcVrrOz_0t20CI_600x450.jpg", what_it_is: "Wooden Cabinet", category: "Furniture", description: "Vintage wooden cabinet. Well-built and sturdy. Doors open and close easily. The finish needs TLC. Missing one knob.")
    l2 = Listing.create(location: "Compton", image_url: "https://images.craigslist.org/00B0B_cqaxgOGLl9Kz_09G07g_600x450.jpg", what_it_is: "Free Glass Corner Desk w/ Chair", category: "Furniture", description: "Free desk, as shown in photo. I've already disassembled it. You just need to take it away. You can also have the office chair. Located in South Loop near Clark St.")
    l3 = Listing.create(location: "Compton", image_url: "https://images.craigslist.org/00909_1vzqKGtEOkpz_0t20CI_600x450.jpg", what_it_is: "Zen 3-D puzzle", category: "Games", description: "I'm selling a fancy, high-end zen puzzle with a 3-D feel to the pieces. The box itself and packaging is very nice, and this would make a great gift. The pieces themselves are very interesting shapes, with pieces the shapes of animals/other unique objects instead of the cookie-cutter jigsaw pieces.")
    l4 = Listing.create(location: "Compton", image_url: "https://images.craigslist.org/00E0E_hgPKmrMDk5nz_0t20CI_600x450.jpg", what_it_is: "Livestrong Treadmill", category: "Exercise Equipment", description: "Currently isnt working, showing an error on the panel. Believe it needs a new motherboard.")
    ...
    l6 = Listing.create(location: "Compton", image_url: "https://images.craigslist.org/00R0R_mNVnc0F9Jrz_0t90CI_600x450.jpg", what_it_is: "wheeled carry on travel bag", category: "Bags", description: "wheeled carry on travel bag")
    l7 = Listing.create(location: "Compton", image_url: "https://assets.specialized.com/i/specialized/96120-41_ROLL-ELITE-LTD-BLK-CMLNGRN-HLGCP_FDSQ?bg=rgb(241,241,241)&w=2500&h=1406&fmt=auto", what_it_is: "Kush Cycle", category: "Bikes", description: "Flex on all your friends")
