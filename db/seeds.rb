...
# end
    ...
    l10 = Listing.create(location: "GHI", image_url: "https://www.awesomeinventions.com/wp-content/uploads/2018/02/feb1518_1.jpg", what_it_is: "Brand new remote", category: "Electronics", description: "TV remote with AA batteries, brand new", user_id: u3.id, winner_id: nil, end_time:"2022-07-01T12:00:00")
...
puts "Seeding Timers....."
    ...
    t13= Timer.create(listing_id: l13.id)
