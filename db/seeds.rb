...
# end
    ...
    l6 = Listing.create(location: "Compton", image_url: "https://images.craigslist.org/00R0R_mNVnc0F9Jrz_0t90CI_600x450.jpg", what_it_is: "Wheeled Carry on Travel Bag", category: "Bags", description: "wheeled carry on travel bag", user_id: u1.id, winner_id: nil, end_time:"2022-07-01T12:00:00")
    l7 = Listing.create(location: "Compton", image_url: "https://assets.specialized.com/i/specialized/96120-41_ROLL-ELITE-LTD-BLK-CMLNGRN-HLGCP_FDSQ?bg=rgb(241,241,241)&w=2500&h=1406&fmt=auto", what_it_is: "Buddy Bike", category: "Bikes", description: "Flex on all your friends", user_id: u1.id, winner_id: nil, end_time:"2022-07-01T12:00:00")

    l8 = Listing.create(location: "ABC", image_url: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQzGy30oLdBfwHCYUuKS3eH0xFqJie_q0lANg&usqp=CAU", what_it_is: "Swag", category: "Cool Factor", description: "Step up your game", user_id: u3.id, winner_id: nil, end_time:"2022-07-01T12:00:00")
    l9 = Listing.create(location: "DEF", image_url: "https://i.pinimg.com/236x/e3/70/08/e37008af8900b12e02f89847abd0de8a--random-pictures-the-day.jpg", what_it_is: "Bush Monster", category: "Outdoor", description: "Get your hedge trimmers!", user_id: u3.id, winner_id: nil, end_time:"2022-07-01T12:00:00")
    l10 = Listing.create(location: "GHI", image_url: "https://www.awesomeinventions.com/wp-content/uploads/2018/02/feb1518_1.jpg", what_it_is: "Remote", category: "Electronics", description: "TV remote with AA batteries, brand new", user_id: u3.id, winner_id: nil, end_time:"2022-07-01T12:00:00")
    ...
    l12 = Listing.create(location: "MNO", image_url: "https://image.invaluable.com/housePhotos/linkauctiongalleries/24/698324/H18786-L249787047.JPG", what_it_is: "Assorted items", category: "Misc", description: "Re-clutter your home!", user_id: u6.id, winner_id: nil, end_time:"2022-07-01T12:00:00")
...
puts "Seeding Timers....."
    ...
    t12= Timer.create(listing_id: l12.id)
